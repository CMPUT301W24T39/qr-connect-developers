...
/**
 * The AdminBrowseEventsTest class is responsible for testing functionalities in the admin browse events page.
 */
...
public class AdminBrowseEventsTest {
    ...
    public void testBackButton(){
        ActivityScenario.launch(AdminBrowseEvents.class);
        onView(withId(R.id.admin_browse_events_back_button)).perform(click());
