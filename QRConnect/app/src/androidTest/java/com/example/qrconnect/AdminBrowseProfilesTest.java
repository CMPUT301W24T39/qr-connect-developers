...
/**
 * The AdminBrowseProfilesTest class is responsible for testing functionalities in the admin browse profiles page.
 */
...
public class AdminBrowseProfilesTest {
    ...
    public void testBackButton(){
        ActivityScenario.launch(AdminBrowseProfiles.class);
        onView(withId(R.id.admin_browse_profiles_back_button)).perform(click());
